...
def process_hierarchy(work_item_url, visited=None, depth=0, is_rework_branch=False):
    ...
    # --- FIX 1: Clean up the Type String (Removes "com.bosch.rtc.configuration.workitemtype.type.") ---
    type_name_short = item_type_str.split("/")[-1] if "/" in item_type_str else item_type_str
    type_name_short = type_name_short.split(".")[-1] # Grabs just the last word (e.g., "review", "task")
...
if __name__ == "__main__":
    logger.info("\n---> [NEW RUN STARTING: UNRESOLVED / NEW RELEASE SUPPORT] <---")
        ...
        with open(INPUT_CSV_FILE, mode="r", encoding="utf-16") as infile:
            ...
            for row in ordered_rows:
                ...
                if response and response.status_code == 200:
                    ...
                    # --- FIX 2: Handling New/In Progress Releases elegantly ---
                    ...
                    res_status = "Unresolved (New / In Progress)" # Clean fallback status
                    if res_url:

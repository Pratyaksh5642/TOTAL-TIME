...
INPUT_CSV_FILE = os.path.join(SCRIPT_DIR, "2025.csv")
OUTPUT_CSV_FILE = os.path.join(SCRIPT_DIR, "output_categorized(2025).csv")
...
def get_owner_details(user_url):
    """Method 2: Pure XML/RDF Extraction"""
...
def get_country_and_rate(owner_string):
    """Maps the owner string to a Country and Rate Card."""
    # ORDER MATTERS: We must check specific strings before checking the generic "MS/"
    if "-AU" in owner_string:
        country = "Australia"
    elif "-JP" in owner_string:
        country = "Japan"
    elif "BGSW/ECC" in owner_string:
        country = "Mexico"
    elif "VM/ESB" in owner_string:
        country = "Germany"
    elif "MS/EHV" in owner_string:
        country = "Vietnam"
    elif "VM/EFO" in owner_string:
        country = "North America"
    elif "-NA" in owner_string:
        country = "North America"
    elif "Adecco, MS/EAS5-VM" in owner_string:
        country = "Vietnam"
    elif "MS/EJH53-VM" in owner_string:
        country = "Vietnam"
    elif "Adecco, MS/ETA-VOS-FBL" in owner_string:
        country = "Vietnam"
    elif "MS/" in owner_string:  # Catch-all for India goes LAST
        country = "India"
    else:
        country = "Others"
        
    # Rate Card mapping based on your requirements
    rate_card = {
        "India": 50000,
        "Mexico": 72727,
        "Vietnam": 42545,
        "China": 80000,
        "Germany": 175000,       # Using Europe rate
        "Hungary": 80000,
        "Japan": 80000,
        "North America": 175000, # Using USA rate
        "Romania": 80000,
        "Portugal": 80000,
        "Austria": 80000,
        "Australia": 175000,
...
if __name__ == "__main__":
    logger.info("\n---> [RUNNING FINAL VERSION: CATEGORIZED & RATE CARD MAPPED] <---")
        ...
        with open(INPUT_CSV_FILE, mode="r", encoding="utf-16") as infile:
            ...
            for row in reader:
                ...
                if release_data:
                    ...
                    # 3. Calculate Country and Rate Card

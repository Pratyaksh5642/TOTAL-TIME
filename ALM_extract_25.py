...
OUTPUT_EXCEL_FILE = os.path.join(SCRIPT_DIR, "GM_Final_data.xlsx") 
LOG_FILE = os.path.join(SCRIPT_DIR, "GM_extraction_log_Final.txt")
MAPPING_CSV_FILE = os.path.join(SCRIPT_DIR, "mapping.csv")
ADDED_LOG_FILE = os.path.join(SCRIPT_DIR, "GM_added_time_log_Final.txt")
...
if __name__ == "__main__":
    logger.info("\n---> [NEW RUN STARTING: FULL PERMUTATION ROSTER MATCHING] <---")
